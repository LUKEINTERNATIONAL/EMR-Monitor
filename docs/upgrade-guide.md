...
2. Logo / Brand Link
  - `<a href="index3.html" class="brand-link"><img src="dist/img/emr_monitor.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8"><span class="brand-text font-weight-light">EMR  Monitor</span></a>` replaces the old logo
3. Sidebar
